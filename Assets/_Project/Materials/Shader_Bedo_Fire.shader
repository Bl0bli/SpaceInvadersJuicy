...
Shader "Shader_Bedo_Fire"
{
	Properties
	{
		...
		_A_Noise_Pan( "A_Noise_Pan", Vector ) = ( 0.1, -0.05, 0, 0 )
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				float smoothstepResult325 = smoothstep( 0.17 , 1.28 , tex2D( _Alpha_Noise, panner320 ).r);
				float2 temp_cast_0 = (smoothstepResult325).xx;
				float2 texCoord329 = IN.texCoord0.xy * float2( 1,1 ) + temp_cast_0;
				float fire_Offset336 = _Fire_Offset;
				float smoothstepResult333 = smoothstep( _Fire_Scale , 0.0 , abs( ( texCoord329.y - fire_Offset336 ) ));
				...
				float3 Burnt287 = ( ( ( smoothstepResult259 * ( 1.0 - smoothstepResult267 ) ) * _Burned_Color.rgb ) + ( smoothstepResult333 * _Fire_Color.rgb ) + ( _Fire_Color.rgb * ( ( 1.0 - smoothstepResult254 ) * smoothstepResult267 ) * Fire_Move264 ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN) : SV_TARGET
			{
				...
				float smoothstepResult325 = smoothstep( 0.17 , 1.28 , tex2D( _Alpha_Noise, panner320 ).r);
				float2 temp_cast_0 = (smoothstepResult325).xx;
				float2 texCoord329 = IN.ase_texcoord.xy * float2( 1,1 ) + temp_cast_0;
				float fire_Offset336 = _Fire_Offset;
				float smoothstepResult333 = smoothstep( _Fire_Scale , 0.0 , abs( ( texCoord329.y - fire_Offset336 ) ));
				float smoothstepResult254 = smoothstep( _Fire_Scale , 0.0 , temp_output_257_0);
				float2 appendResult46 = (float2(0.0 , 0.1));
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;317;-5488,-768;Inherit;False;Property;_A_Noise_Tile;A_Noise_Tile;15;0;Create;True;0;0;0;False;0;False;1.5,1.5;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;315;-5520,-896;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.5,0.5;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;305;-5648,-512;Inherit;False;3748;1717;;40;299;298;260;248;251;256;253;258;257;304;262;301;267;303;276;268;297;281;259;302;265;269;294;277;300;249;254;168;275;293;272;266;250;273;292;283;287;295;335;336;Separation Lignes Fire Burn Alpha;1,0.5651821,0,1;0;0
...
Node;AmplifyShaderEditor.ScaleAndOffsetNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;318;-5296,-896;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;1,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;328;-5264,-768;Inherit;False;Property;_A_Noise_Pan;A_Noise_Pan;16;0;Create;True;0;0;0;False;0;False;0.1,-0.05;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.PannerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;320;-5072,-896;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;325;-4576,-896;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.17;False;2;FLOAT;1.28;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;329;-4304,-880;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;337;-4288,-720;Inherit;False;336;fire_Offset;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;330;-4048,-864;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;332;-3824,-864;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;333;-3680,-864;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.14;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;335;-3072,176;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;331;-4336,-640;Inherit;False;Constant;_Float0;Float 0;20;0;Create;True;0;0;0;False;0;False;0.265898;0;0;1;0;1;FLOAT;0
...
WireConnection;330;0;329;2
WireConnection;330;1;337;0
...
ASEEND*/
//CHKSM=C61485FCBE6979B8C9477333B967009FB0F8B0F9